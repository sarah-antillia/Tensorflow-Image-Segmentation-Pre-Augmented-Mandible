...
if __name__ == "__main__":
  try:
    images_dir = "./Augmented-Mandible-master/images/"    
    masks_dir  = "./Augmented-Mandible-master/masks/"
    output_dir = "./Augmented-Mandible-ImageMask-Dataset/"
